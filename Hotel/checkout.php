      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
            ...
            <form action="check.php #next" method="post" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
			  
			    <div class="col-md-6 form-group">
                  <label class="text-black font-weight-bold" for="name">Enter Your Name</label>
                  <input type="text" name="name" class="form-control" required>
                </div>
             
			  
                <div class="col-md-6 form-group">
                  <label class="text-black font-weight-bold" for="roomnumber">Enter Your room number</label>
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" value="Checkout Now" name="checkout" class="btn btn-primary text-white py-3 px-5 font-weight-bold">
                </div>
              </div>
            </form>
